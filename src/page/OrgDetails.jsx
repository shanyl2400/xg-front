...
import SubOrgItemView from '../component/SubOrgItemView';
    ...
    return (
        <div style={{ padding: 40, height: "100%", width: "100%" }}>
            ...
            <Card style={{ width: "100%", margin: "20px 5px" }}>
                ...
                <Row gutter={[16, 16]}>
                    <Col span={12}>地址：{orgData.address}</Col>
                </Row>
            ...
            {orgData.sub_orgs != undefined && orgData.sub_orgs.map((v)=>
              <SubOrgItemView 
                name={v.name} 
                address={v.address} 
                intentSubject={v.subjects}
              />
            )}
